...
<body background="imagenes/frame2.jpg">

  <div class="container">
    <div id="buscador"></div>
    <div id="tabla"></div>
  </div>
        <Center><a style="font-family:verdana;background-color:white;color:black;" href="cerrarseccion.php">Cerrar Sesion</a></Center>
